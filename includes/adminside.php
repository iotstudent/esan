<div class="col-md-2 bg-brand sidenav ">
    ...
    <div class="row">
        <ul>
            ...
            <li class="sidenav--link"><a href="vacancy.php" class="text-white"><i class="fa fa-wrench mr-2"></i>Vacancy</a></li>
            <li class="sidenav--link"><a href="reports.php" class="text-white"><i class="fa fa-folder mr-2"></i>Report</a></li>
            <li class="sidenav--link"><a href="duespayment.php" class="text-white"><i class="fa fa-credit-card mr-2"></i>Dues</a></li>
